...
namespace project1
{
    public partial class Form1 : Form
    {
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            ...
            if (isClickedWRandWa == false || textBox11.Text == "")
            {
                isClickedWRandWa = true;
                textBox11.ReadOnly = false;
            }
            else if (Regex.IsMatch(textBox11.Text, @"^[\d]{1,5}$"))
            {
        ...
        private void button31_Click(object sender, EventArgs e)
        {
            ...
            chart20.Legends[0].Position = new System.Windows.Forms.DataVisualization.Charting.ElementPosition(79, 55, 18, 22);
